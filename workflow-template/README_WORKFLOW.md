# GitHub Workflow (Anti-Gravity & Jules)

To avoid conflicts with Google Jules and protect the `main` branch, use the following workflow:

1. **Jules Catchup:** Always pull the latest changes before starting.
