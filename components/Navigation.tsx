...
const serviceNavItems = {
  de: [
    ...
    { name: 'Ablauf', href: '#webdesign-services', icon: ListChecks },
    { name: 'Referenzen', href: '#main-content', icon: Briefcase },
    { name: 'Kontakt', href: '#main-content', icon: Mail },
  ],
  en: [
    { name: 'Services', href: '#webdesign-services', icon: Sparkles },
    { name: 'Process', href: '#webdesign-services', icon: ListChecks },
    { name: 'Proof', href: '#main-content', icon: Briefcase },
    { name: 'Contact', href: '#main-content', icon: Mail },
  ],
};
  ...
  return (
    <>
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#050505]/80 backdrop-blur-md border-b border-neutral-800 py-3' : 'bg-transparent py-6'} hidden md:block`}
      >
