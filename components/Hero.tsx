...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative scroll-mt-28 flex flex-col items-center justify-center text-center space-y-8 pt-20">
      ...
      >
        Ich entwickle <span className="text-white">performante Websites und optimierte Workflows</span> mit klarem Fokus auf Business-Impact: schnellere Umsetzung, saubere Übergaben und messbare Ergebnisse.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-24 text-left border-t border-neutral-900 pt-12">
        <div className="space-y-3">
          ...
          <p className="text-sm text-neutral-200 leading-relaxed">Automatisierte Entwicklungsprozesse und effiziente Pipelines. Schnelle Iterationen, präzise Resultate.</p>
        </div>
        <div className="space-y-3">
          <div className="flex items-center text-blue-500 mono text-[10px] tracking-[0.05em]">
