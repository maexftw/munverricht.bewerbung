...
/**
 * munverricht-portfolio theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { munverrichtPortfolioTheme } from './munverricht-portfolio';
 *   import './munverricht-portfolio.css';
 */
export const munverrichtPortfolioTheme = {
  ...
  tokens: {
    ...
    "--font-family-code": "\"JetBrains Mono\", \"SFMono-Regular\", Consolas, \"Liberation Mono\", Menlo, monospace",
    ...
    "--color-background-body": "light-dark(#eef3fb, #05070d)",
    "--color-background-card": "light-dark(#ffffff, #0f1118)",
    "--color-background-popover": "light-dark(#ffffff, #101624)",
    "--color-background-muted": "light-dark(#f7faff, #0a0e18)",
    "--color-accent": "light-dark(#2563eb, #60a5fa)",
    "--color-accent-muted": "light-dark(#dbeafe, #1d4ed833)",
    ...
    "--color-text-primary": "light-dark(#0f172a, #edf2ff)",
    "--color-text-secondary": "light-dark(#52627a, #c8d3eb)",
    "--color-text-disabled": "light-dark(#748399, #67748e)",
    "--color-text-accent": "light-dark(#1d4ed8, #93c5fd)",
    ...
    "--color-icon-accent": "light-dark(#2563eb, #60a5fa)",
    "--color-icon-primary": "light-dark(#0f172a, #edf2ff)",
    "--color-icon-secondary": "light-dark(#52627a, #8e9ab2)",
    ...
    "--color-border": "light-dark(#47556924, #95a5c32e)",
    "--color-border-emphasized": "light-dark(#4755693d, #95a5c347)",
